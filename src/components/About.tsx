          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-5 text-lg text-gray-700 leading-relaxed">
                <p>
                  Founded by <span className="font-semibold text-gray-900">Dayan Diddeniya</span>, a former Sri Lanka Rugby player and coach, Gampaha RFC was established with a vision to create a premier rugby club in Gampaha that embodies excellence, inclusivity, and unwavering community spirit.
                </p>
                <p>
                  Our club has rapidly established itself as a formidable force in Sri Lanka rugby. We made history as the <span className="font-semibold text-gray-900">first Sri Lankan alumni side</span> to compete in the prestigious Emirates Dubai Rugby 7s tournament, where we proudly captured the <span className="font-semibold text-gray-900">Gulf Men's Social Plate Championship in 2024</span>.
                </p>
                <p>
                  At Gampaha RFC, we're committed to developing more than just skilled athletes. We cultivate well-rounded individuals who embody the core values of teamwork, respect, discipline, and sportsmanship both on and off the field.
                </p>
              </div>
            </div>
          </div>
