    ...
    <footer className="bg-gray-950 text-white">
      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                <Mail className="h-5 w-5 text-gray-100 flex-shrink-0 mt-0.5" />
                <a
              ...
              <li className="flex items-start gap-2">
                <Phone className="h-5 w-5 text-gray-100 flex-shrink-0 mt-0.5" />
                <a
              ...
              <li className="flex items-start gap-2">
                <MapPin className="h-5 w-5 text-gray-100 flex-shrink-0 mt-0.5" />
                <span className="text-gray-400">Gampaha, Sri Lanka</span>
              </li>
            </ul>
            ...
            <div className="flex items-center gap-3 mt-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-900 p-2 rounded-full hover:bg-white hover:text-black transition-colors"
                aria-label="Facebook"
              >
        ...
        <div className="border-t border-gray-800 pt-6 text-center text-sm text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} Gampaha RFC. All rights
            reserved.
          </p>
        </div>
      </div>
