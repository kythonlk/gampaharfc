    ...
    return (
        <>
            <div className="fixed w-full p-2 h-10 flex z-50 sm:hidden items-center gap-3 justify-between text-base font-semibold bg-black/80">
                ...
                <div className='flex gap-4'>
                    <a href="https://www.facebook.com/dubaituskersrfc"
                        target="_blank" className="text-gray-200 hover:text-gray-400 transition-all duration-300"><Facebook className="h-4 w-4" /></a>
                    <a href="https://www.instagram.com/dubaituskersrfc"
                        target="_blank" className="text-gray-200 hover:text-gray-400 transition-all duration-300"><InstagramIcon className="h-4 w-4" /></a>
                    <a href="https://www.linkedin.com/company/dubaituskersrfc"
                        target="_blank" className="text-gray-200 hover:text-gray-400 transition-all duration-300"><Linkedin className="h-4 w-4" /></a>
            ...
            <header className="fixed flex sm:flex-col w-full top-10 sm:top-0 left-0 right-0 z-50 font-rajdhani font-semibold bg-black/70 backdrop-blur-md border-b border-gray-200">
                        ...
                        <div className="sm:flex hidden items-center gap-3 sm:gap-5 justify-center text-white">
                            ...
                            <a href="https://www.shop.dubaituskers.com/"
                                ...
                                <button className="relative px-6 py-2.5 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white font-semibold text-sm tracking-wide overflow-hidden group">
                                    <div className="absolute inset-0 bg-gradient-to-r from-gray-950 to-gray-900 translate-x-full group-hover:translate-x-0 transition-transform duration-500" />
                ...
                ${currentPage === `/${item.page}` ? 'text-gray-300' : 'text-white/90 hover:text-white'}
              `}
                                    >
                ...
                <div className="sm:hidden flex justify-center flex-col mx-auto">
                    <button
                        ...
                        className="xl:hidden p-3 text-black/90 hover:text-gray-600 hover:bg-white/5 rounded-lg transition-all w-full"
                    >
              ...
              `}
                            ...
                            <div className="pt-6 border-t border-white/10 space-y-4">
                                <button className="w-full px-6 py-3 bg-gradient-to-r from-gray-900 to-black text-white font-semibold text-sm rounded-lg flex items-center justify-center gap-2">
                                    <ShoppingBag className="h-4 w-4" />
                                    <span>SHOP</span>
                                </button>
                                <div className="flex items-center justify-center gap-6 pt-2">
                                    <a href="https://www.facebook.com/dubaituskersrfc"
                                        target="_blank" className="text-gray-400 hover:text-gray-100 transition-colors"><Facebook className="h-5 w-5" /></a>
                                    <a href="https://www.instagram.com/dubaituskersrfc"
                                        target="_blank" className="text-gray-400 hover:text-gray-100 transition-colors"><InstagramIcon className="h-5 w-5" /></a>
                                    <a href="https://www.linkedin.com/company/dubaituskersrfc"
                                        target="_blank" className="text-gray-400 hover:text-gray-100 transition-colors"><Linkedin className="h-5 w-5" /></a>
                                    <a href="https://www.youtube.com/@DubaiTuskers/"
                                        target="_blank" className="text-gray-400 hover:text-gray-100 transition-colors"><Youtube className="h-5 w-5" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
