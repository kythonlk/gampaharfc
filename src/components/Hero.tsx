          ...
          <div className="max-w-3xl">
            ...
            {slides[index].cta && (
              <Link to={slides[index].link}>
                <button className="relative px-4 sm:px-6 py-2 my-4 bg-white text-gray-900 font-semibold text-lg tracking-wide overflow-hidden group hover:bg-gray-200 transition-colors">
                  {slides[index].cta}
                </button>
              </Link>
            )}
