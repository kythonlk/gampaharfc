  ...
  const tiers = [
    {
      ...
      price: 'LKR 1,000,000/-',
      color: 'from-gray-700 to-gray-900', // Premium dark slate for top tier
      benefits: [
      ...
      <section className="bg-gray-900 text-white py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center text-gray-300 max-w-3xl mx-auto mt-4">
            Partner with Gampaha RFC and be part of our growing success story
          </p>
        </div>
                  ...
                  <ul className="space-y-3">
                    {tier.benefits.map((benefit, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <span className="text-gray-900 mt-1">&bull;</span>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Gampaha RFC is a rapidly growing rugby club with a strong
                ...
                supporting the development of rugby in the Sri Lanka.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-gray-900 rounded-xl shadow-lg p-6 text-white hover:shadow-2xl transition-all transform hover:-translate-y-2"
                  >
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="bg-gray-900 rounded-xl shadow-2xl p-8 md:p-12 text-white">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center gap-2 bg-gray-900 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-black transition-colors shadow-lg"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white text-gray-900 px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors shadow-lg"
              >
