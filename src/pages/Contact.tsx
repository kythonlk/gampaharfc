  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-gray-900 rounded-xl shadow-2xl p-8 md:p-12 text-white text-center">
            <h2 className="text-3xl font-bold mb-4">Visit Us</h2>
            <div className="w-24 h-1 bg-white mx-auto mb-6"></div>
            <p className="text-lg text-gray-300 mb-6">
              Come watch a match or join us for a training session at Gampaha. We train Tuesday, Thursday evenings and Saturday mornings.
            </p>
            <a
              href="https://www.google.com/maps/search/Gampaha"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white text-black px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-200 transition-colors shadow-lg"
            >
