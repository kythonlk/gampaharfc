        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200 hover:border-black transition-colors">
                ...
                <Link
                  ...
                  className="text-gray-900 font-semibold hover:text-black transition-colors"
                >
