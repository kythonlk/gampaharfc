    ...
    <section className="py-20 bg-gray-900 min-h-screen text-white">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="border border-white/20 bg-white/5 backdrop-blur-sm p-10 shadow-2xl">
          ...
          <h1 className="text-3xl font-bold text-center mb-10 tracking-wide text-white uppercase">
            {match.competition}
          </h1>
          ...
          <div className="flex items-center justify-between mb-12">
            ...
            <span className="hidden md:block text-5xl font-extrabold text-white">
          ...
          <span className="md:hidden text-4xl font-extrabold text-white flex items-center justify-center py-4">
            {match.status === "completed"
              ? `${match.home_score} - ${match.away_score}`
              : "VS"}
          </span>
          <div className="space-y-4 text-center text-white text-lg tracking-wide">
