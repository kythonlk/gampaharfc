...
export default function Teams() {
  const teams = [
    ...
    },
    {
      ...
      description: 'Building the next generation of Gampaha RFC talent',
      details: [
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {teams.map((team, index) => (
              <div
                key={index}
                className="bg-white rounded-xl shadow-lg overflow-hidden border-t-4 border-gray-900 hover:shadow-2xl transition-all transform hover:-translate-y-2"
              >
                  ...
                  <ul className="space-y-3">
                    {team.details.map((detail, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <Trophy className="h-5 w-5 text-gray-900 flex-shrink-0 mt-0.5" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 bg-gray-100 border-l-4 border-gray-900 p-6 rounded-r-lg">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 mb-8">
              ...
              we have a place for you in the Gampaha RFC family. Join us for a trial
