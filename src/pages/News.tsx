      ...
      <section className="bg-gray-900 text-white py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center text-gray-300 max-w-3xl mx-auto">
            Stay informed with the latest updates from Gampaha RFC
          </p>
        </div>
      </section>
                ...
                >
                  <div className="md:flex">
                    ...
                    <div className={article.image_url ? 'md:w-2/3 p-8' : 'p-8'}>
                      ...
                      <Link to={`/news/${article.id}`} className="text-gray-900 font-semibold hover:text-gray-600 transition-colors inline-flex items-center gap-2">
                        Read Full Article
                        <span>→</span>
                      </Link>
                    </div>
