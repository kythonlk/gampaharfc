...
export default function TeamPage() {
  ...
  const teams: Record<string, {
    ...
    "15s": {
      ...
      short:
        "Gampaha RFC proudly competes in full-contact 15-a-side rugby, representing the club in the Sri Lnaka Rugby Leagues. This format showcases structure, discipline, and teamwork — the classic heart of world rugby.",
      description:
        "15s rugby demands strategy, physicality, and unity. Our squad brings intensity, intelligence, and brotherhood to every match as we progress through the Sri Lanka rugby ecosystem. This is the battlefield where every phase counts.",
      highlights: [
        ...
        "👥 Strong community presence in Sri Lanka rugby"
      ],
      training: {
    ...
    "10s": {
      ...
      description:
        "10s rugby rewards pace, intelligent support lines, and quick decision-making. The squad competes across Sri Lanka tournaments and serves as a development pathway toward our elite 7s program.",
      highlights: [
        "High-tempo matches with quick transitions",
        "Focus on tactical movement and handling skills",
        "Regular participation in Sri Lanka 10s tournaments",
    ...
    "7s": {
      ...
      short:
        "High-speed, high-intensity, elite-level rugby. Our 7s squad represents Gampaha RFC in major Sri Lanka tournaments.",
      description:
        "Rugby 7s demands explosive pace, elite conditioning, and tactical precision. The Gampaha RFC 7s team competes at a high standard across Sri Lanka tournaments while developing players for international-level opportunities.",
      highlights: [
        "Elite conditioning and speed-focused training",
        "Advanced tactical systems built around space and movement",
        "Participation in top Sri Lanka 7s competitions",
    ...
    "touch": {
      ...
      description:
        "Touch Rugby builds speed, coordination, and strategy without physical tackling. It’s a core part of Gampaha RFC culture — ideal for beginners, mixed teams, or players looking to sharpen their running and handling skills.",
      highlights: [
    ...
    <div className="font-rajdhani">
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold mb-10 uppercase tracking-wide text-white">
      ...
      <section className="py-10 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold mb-10 uppercase tracking-wide text-gray-900">
            Training & Team Ethos
          </h2>
          <p className="text-gray-700">Our {t.title} squad trains weekly under the guidance of experienced coaches. with a focus on tactical preparation, physical conditioning, and team unity. Every player is valued — whether you’re a seasoned lock or a new winger – because we play as one.</p>
        </div>
      </section >
