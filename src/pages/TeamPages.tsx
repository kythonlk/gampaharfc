...
export default function TeamPage() {
    ...
    const teams: Record<string, {
        ...
        "15s": {
            ...
            short:
                "Gampaha RFC proudly competes in full-contact 15-a-side rugby, representing the club in the UAE Rugby League (Division 2). This format showcases structure, discipline, and teamwork — the classic heart of world rugby.",
            description:
        ...
        "7s": {
            ...
            short:
                "High-speed, high-intensity, elite-level rugby. Our 7s squad represents Gampaha RFC in major tournaments including the Dubai 7s.",
            description:
                "Rugby 7s demands explosive pace, elite conditioning, and tactical precision. The Gampaha RFC 7s team competes at a high standard across UAE tournaments while developing players for international-level opportunities.",
            highlights: [
