    ...
    return (
      <section className="bg-gray-900 min-h-screen flex items-center justify-center">
        <div className="text-white flex flex-col items-center">
          <div className="h-12 w-12 border-4 border-white border-t-transparent animate-spin"></div>
      ...
      <div className="mx-2 md:mx-20 px-4">
        ...
        <div className="bg-white text-black shadow-2xl border border-black/10 p-0 rounded-none">
          ...
          <div className="p-2 sm:p-8 rounded-none">
            ...
            <h1 className="text-2xl sm:text-4xl font-bold tracking-wide mb-4 text-gray-900">
              {news.title}
            </h1>
