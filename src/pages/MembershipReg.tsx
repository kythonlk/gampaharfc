        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded-xl p-8 space-y-6">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full mt-6 bg-gray-900 text-white px-6 py-3 rounded-lg font-bold text-lg hover:bg-black transition-colors disabled:opacity-50"
            >
